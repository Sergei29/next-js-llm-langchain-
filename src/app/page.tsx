...
const HomePage = () => {
  return (
    <div className="w-11/12 m-auto flex-col my-6">
        ...
        <div className="flex flex-col items-start justify-center min-h-screen text-gray-800 py-4 px-4 sm:px-6 lg:px-8 w-6/12">
          ...
          >
            <span className="font-bold">
              Throughout this course, you&rsquo;ll be building stunning AI
              projects that are not only impressive but also have real-world
              applications.
            </span>
            Whether you&rsquo;re aiming to generate a passive income, create a
      ...
      >
        Remember, this journey is yours. So let&rsquo;s{' '}
